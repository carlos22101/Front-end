...
function preferNmBin(env, ...dirs) {
  ...
  const pathValue = dirs.map((c) => c && import_node_path.default.resolve(c, "node_modules", ".bin")).concat(env[pathKey]).filter(Boolean).join(import_node_path.default.delimiter);
